...
if __name__ == "__main__":
	...
	parser.add_argument('--hazy_images_path', type=str, default="data/HAZE/")
	...
	parser.add_argument('--snapshots_folder', type=str, default="train_weights/")
